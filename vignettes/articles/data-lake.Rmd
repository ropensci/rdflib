...
Configure RDF storage to use the Virtuoso backend.

```{r options, include = TRUE}
rdf <- rdf(storage = "virtuoso", 
                   user = "dba", 
                   password = "dba", 
                   dsn = "Local Virtuoso", 
                   new_db = TRUE
...
as_rdf(airlines, rdf = rdf, key = "carrier", prefix = "x:")
as_rdf(planes,  rdf = rdf, key = "tailnum", prefix = "x:")
as_rdf(uri_flights, rdf = rdf, key = NULL, prefix = "x:")
